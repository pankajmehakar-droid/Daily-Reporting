...
import { User, REGIONS } from '../types';
      ...
      {!isAuthorized ? (
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 text-center">
          <p className="text-red-500 dark:text-red-400 font-semibold">
            You do not have permission to view Region Management.
          </p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            This page allows for the management of organizational regions.
            {currentUser.role === 'admin' && ' As an Administrator, you can manage all regions.'}
            {currentUser.designation.toUpperCase() === 'ZONAL MANAGER' && ' As a Zonal Manager, you can view and manage regions relevant to your scope.'}
          </p>

          <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-3">Current Regions</h3>
          ...
          {/* Future: Add form for adding new regions */}
          {currentUser.role === 'admin' && (
            <div className="mt-6 p-4 border-t border-gray-200 dark:border-gray-700">
              <button className="btn btn-indigo">Add New Region</button>
            </div>
          )}
        </div>
      )}
